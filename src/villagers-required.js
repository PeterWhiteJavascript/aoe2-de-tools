$(function () {
  let ecoBonuses = {
    civ: {
      ...
      'Japanese - Feudal Age': {
        'fishing ship shore': 0.1,
        'fishing ship deep': 0.1,
        'fish trap': 0.1,
      },
      'Japanese - Castle Age': {
      ...
      'Japanese - Imperial Age': {
        'fishing ship shore': 0.2,
        'fishing ship deep': 0.2,
        'fishing ship shore gillnets': 0.2,
        'fishing ship deep gillnets': 0.2,
        'fish trap': 0.2,
        'fish trap gillnets': 0.2,
      },
      'Aztecs (Farms)': {
        farmer: '22.46',
  ...
  $.getJSON('/data.json', function (data) {
    ...
    let order = [
      [
        ...
        'fishing ship shore',
        'fishing ship deep',
        'fishing ship shore gillnets',
        'fishing ship deep gillnets',
        'fish trap',
        'fish trap gillnets',
        'feitoria food',
        'relic food',
      ...
      [
        ...
        'feitoria gold',
        'gold from stone',
        'gold from stone mining',
        'gold from stone shaft',
      ],
    ...
    let unitVariety = {
      ...
      genitour: {
        civs: {
          ...
          'Huns - Castle Age': {
            cost: { food: 0.1, wood: 0.1 },
            costPercent: true,
          },
          'Huns - Imperial Age': {
            cost: { food: 0.2, wood: 0.2 },
            costPercent: true,
          },
          'Koreans Civ Bonus': {
            cost: { wood: 0.2 },
        ...
        for (let i = 0; i < applyEcoBonuses.length; i++) {
          for (let j in applyEcoBonuses[i].data) {
            if (applied[j] >= 0) {
              ...
              applied[j] =
                gatherRates[j].gatherRate * (1 + applyEcoBonuses[i].data[j])
            }
          }
        }
