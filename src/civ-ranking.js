...
$.getJSON('/data.json', function(data) {
    ...
    */
    ...
    data.civilizations.forEach((civ, i) => {
        $("#civ-conts").append("<div class='civ-cont' civid='"+i+"'><img src='/img/civicon-"+(civ.name.toLowerCase())+".webp'><div>"+civ.name+"</div></div>");
    ...
    $(".civ-cont").click((e) => {
        ...
        for(let i = 0; i < buildings.length; i++){
            ...
            row.append("<div class='building'>"+"<div><img src='/img/"+buildings[i]+".webp'></div>"+"</div>");
            ...
            for(let j = 0; j < units.length; j++){
                ...
                unitdiv.append("<div class='unit'>"+"<img src='/img/"+unit+".webp'>"+"</div>");
                ...
                unitdiv.mouseenter((e) => {
                    ...
                    uniqueUps.forEach((affectsUnit, i) => {
                        if(affectsUnit){
                            upgradesDiv.children(".relative-upgrades").append("<div class='relevant-img'><img src='/img/"+civ.ranksUnique[i][0]+".webp'></div>");
                        }
                    });
        ...
        bsmithUps.forEach((u) => {
            bsmithdiv.append("<div class='desc-img'><img src='/img/"+u+".webp'></div>");
        });
        ...
        ups.forEach((u, i) => {
            ...
            u.forEach((a) => {
                let img = $("<div class='desc-img'><img src='/img/"+a+".webp'></div>");
